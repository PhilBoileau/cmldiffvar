...
This outlines how to propose a change to cmldiffvar. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PhilBoileau/cmldiffvar", fork = TRUE)`.
...
Please note that the cmldiffvar project is released with a [Contributor
Code of Conduct](https://pboileau.ca/cmldiffvar/CODE_OF_CONDUCT.md). By
