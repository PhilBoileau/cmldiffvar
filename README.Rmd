...
potential outcome variances, on a random sample of the `toy_population_tbl` data
included with the `cmldiffvar` package. We use a targeted maximum likelihood
estimator that allows adjustment for confounding variables. The true absolute
differential variance in this population is $2$, indicating that there is
